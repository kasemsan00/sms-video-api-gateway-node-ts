...
export enum ErrorCode {
  ...
  ROOM_ALREADY_OPEN = 'ROOM_ALREADY_OPEN',
...
export const ERROR_CODE_TO_HTTP_STATUS: Record<ErrorCode, number> = {
  ...
  [ErrorCode.ROOM_ALREADY_OPEN]: 422,
  ...
  [ErrorCode.INVALID_DAYS]: 422,
  [ErrorCode.INVALID_LATITUDE]: 422,
  [ErrorCode.INVALID_LONGITUDE]: 422,
  [ErrorCode.EMPTY_MESSAGE]: 422,
  [ErrorCode.MESSAGE_TOO_LONG]: 422,
  [ErrorCode.MESSAGE_ALREADY_DELETED]: 422,
  [ErrorCode.INVALID_NAME]: 422,
  [ErrorCode.CANNOT_REMOVE_ADMIN]: 422,
  [ErrorCode.CANNOT_REMOVE_SELF]: 422,
